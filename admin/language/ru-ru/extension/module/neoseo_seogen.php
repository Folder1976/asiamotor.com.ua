...
$_['entry_products_description'] = 'HTML-тег description:<br><span class="help"> Доступные теги: [product_id], [product_name], [sku], [price], [model_name], [manufacturer_name], [category_name], [product_description]</span>';
$_['entry_products_keywords'] = 'HTML-тег keywords:<br><span class="help"> Доступные теги: [product_id], [product_name], [product_keyword], [sku], [price], [model_name], [manufacturer_name], [category_name]</span>';
$_['entry_categories_seo_url'] = 'SEO URL:<br><span class="help"> Доступные теги: [category_name]</span>';
$_['entry_categories_h1'] = 'HTML-тег h1:<br><span class="help"> Доступные теги: [category_name], [category_h1]</span>';
$_['entry_categories_title'] = 'HTML-тег title:<br><span class="help">Доступные теги: [category_name], [category_title]</span>';
$_['entry_categories_description'] = 'HTML-тег description:<br><span class="help"> Доступные теги: [category_name], [category_description]</span>';
$_['entry_categories_keywords'] = 'HTML-тег keywords:<br><span class="help"> Доступные теги: [category_name], [category_keyword]</span>';
...
$_['entry_blogs_seo_url'] = 'SEO URL:<br><span class="help"> Доступные теги: [blog_name]</span>';
$_['entry_blogs_h1'] = 'HTML-тег h1:<br><span class="help"> Доступные теги: [blog_title], [blog_h1]</span>';
$_['entry_blogs_title'] = 'HTML-тег title:<br><span class="help">Доступные теги: [blog_title], [blog_title]</span>';
$_['entry_blogs_description'] = 'HTML-тег description:<br><span class="help"> Доступные теги: [blog_title], [blog_description]</span>';
$_['entry_blogs_keywords'] = 'HTML-тег keywords:<br><span class="help"> Доступные теги: [blog_title], [blog_keyword]</span>';
$_['entry_remove_list'] = 'Список слов для удаления из URL. Разделитель - запятая';
$_['entry_cron'] = 'CRON';
...
$_['params_blogs_seo_url'] = '[blog_name]';
$_['params_blogs_h1'] = '[blog_h1]';
$_['params_blogs_title'] = '[blog_title]';
$_['params_blogs_description'] = '[blog_description]';
$_['params_blogs_keywords'] = '[blog_keyword]';
