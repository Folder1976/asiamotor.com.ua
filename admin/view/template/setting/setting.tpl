      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-title" data-toggle="tab">Заголовки CEO</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-title">
              <fieldset>
                <legend>Для товара @name@ @price@</legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label">title</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_product_title" value="<?php echo $config_ceo_product_title; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">H1</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_product_h1" value="<?php echo $config_ceo_product_h1; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">meta Description</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_product_description" value="<?php echo $config_ceo_product_description; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">meta Keywords</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_product_keywords" value="<?php echo $config_ceo_product_keywords; ?>" class="form-control" />
                  </div>
                </div>
                
                <legend>Для категорий @name@</legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label">title</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_category_title" value="<?php echo $config_ceo_category_title; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">H1</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_category_h1" value="<?php echo $config_ceo_category_h1; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">meta Description</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_category_description" value="<?php echo $config_ceo_category_description; ?>" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">meta Keywords</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_ceo_category_keywords" value="<?php echo $config_ceo_category_keywords; ?>" class="form-control" />
                  </div>
                </div>
