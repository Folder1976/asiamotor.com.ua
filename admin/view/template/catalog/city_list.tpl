		...
		<div class="row">
            <div class="col-sm-12">
              <div class="form-group col-sm-8">
                <label class="control-label" for="input-name">Строка поиска</label>
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="Имя, алиас" id="input-name" class="form-control" />
              </div>
              
              <button type="button" id="button-filter" class="btn btn-primary pull-right col-sm-4"><i class="fa fa-filter"></i> Фильровать</button>
            </div>
          </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'ad.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'alias') { ?>
                    <a href="<?php echo $sort_alias; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_alias; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_alias; ?>"><?php echo $column_alias; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $city['alias']; ?></td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/city&token=<?php echo $token; ?>';
