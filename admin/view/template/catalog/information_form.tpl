              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    Памятка по ключам:<br>
                    Имя города <b>@name@</b><br>
                    Имя города Родительный (Кого? Чего?) <b>@name_rod@</b><br>
                    Имя города Дательный (Кому? Чему?)<b> @name_dat@</b><br>
                    Телефон <b>@telephone@</b><br>
                    Запасное поле <b>@text1@ @text2@ @text3@ @text4@</b><br>
