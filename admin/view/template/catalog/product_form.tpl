              ...
              <div class="tab-pane" id="tab-extra_tabs<?php echo $extra_tab_row; ?>">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="extra_tab_description<?php echo $extra_tab_row; ?><?php echo $language['language_id']; ?>">
                    <textarea name="oct_product_extra_tab[<?php echo $extra_tab_row; ?>][oct_product_extra_tab_description][<?php echo $language['language_id']; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control summernote" id="extra_tab_description_textarea<?php echo $extra_tab_row; ?><?php echo $language['language_id']; ?>"><?php echo isset($oct_product_extra_tab['oct_product_extra_tab_description'][$language['language_id']]) ? $oct_product_extra_tab['oct_product_extra_tab_description'][$language['language_id']]['text'] : ''; ?></textarea>
                  </div>
                  <?php } ?>
                </div>
              </div>
...
function addImage() {
		...
		$('#modal-image').remove();
		$.ajax({
			url: 'index.php?route=common/filemanager&token=' + getURLVar('token') + '&multiple=1',
			dataType: 'html',
