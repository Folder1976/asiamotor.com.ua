...
<div id="content">
  <div class="page-header">
    ...
    <script>
      function delete_is_disabled(){
        location.href = '<?php echo str_replace('&amp;','&',$delete_is_disabled); ?>';
      }
    </script>
    
    
      <div class="pull-right">
        <button type="button" data-toggle="tooltip" title="Удалить все отключенные товары!" class="btn btn-danger" onclick="confirm('Удалить все отключенные товары?') ? delete_is_disabled() : false;"><i class="fa fa-trash-o"></i> Удалить отключенные</button>
