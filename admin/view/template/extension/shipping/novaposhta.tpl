										...
										<div class="form-group">
								            ...
								            <div class="col-sm-10">
								            	...
								            	<div class="tab-content">
									            	<?php foreach ($languages as $language) { ?>
									    				<div role="tabpanel"
															class="tab-pane<?php echo ($language_id == $language['language_id']) ? ' active' : '' ?>"
															id="warehouse_name_<?php echo $language['language_id']; ?>">	
									              			
															<input type="text"
																   name="novaposhta[shipping_methods][warehouse][name][<?php echo $language['language_id']; ?>]"
																   value="<?php echo $novaposhta['shipping_methods']['warehouse']['name'][$language['language_id']]; ?>"
																   placeholder="<?php echo $entry_name; ?>"
																   id="input-warehouse_name_<?php echo $language['language_id']; ?>" class="form-control" />
									              		</div>
									              	<?php } ?>
								            	</div>
								        	</div>
