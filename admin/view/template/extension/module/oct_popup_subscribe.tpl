        ...
        <form method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="setting-tab">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_delay; ?></label>
                <div class="col-sm-10">
                  <div class="input-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
						  <select name="oct_popup_subscribe_form_data[template_status]" id="input-template_status" class="form-control">
							<?php if ($oct_popup_subscribe_form_data['template_status']) { ?>
							<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
							<option value="0"><?php echo $text_disabled; ?></option>
							<?php } else { ?>
							<option value="1"><?php echo $text_enabled; ?></option>
...
<script type="text/javascript"><!--
  <?php foreach ($languages as $language) { ?>
	$('#promo-text-language<?php echo $language['language_id']; ?>').summernote({height: 200});
	$('#email_template_first<?php echo $language['language_id']; ?>').summernote({height: 200});
	$('#email_template_second<?php echo $language['language_id']; ?>').summernote({height: 200});
  <?php } ?>
//--></script>
<?php } ?>
<script type="text/javascript">
