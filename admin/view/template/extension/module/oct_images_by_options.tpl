          ...
          <div class="tab-content">
            <div class="tab-pane active" id="setting-tab">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="oct_images_by_options_data[status]" id="input-status" class="form-control">
                    <?php if ($oct_images_by_options_data['status']) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="oct_images_by_options_data[allowed_options][<?php echo $row; ?>]" value="<?php echo $option['option_id']; ?>" <?php echo (!empty($oct_images_by_options_data['allowed_options'][$row])) ? 'checked' : ''; ?> /> <?php echo $option['name']; ?>
                      </label>
                    </div>
                    <?php $row++; ?>
                    <?php } ?>
