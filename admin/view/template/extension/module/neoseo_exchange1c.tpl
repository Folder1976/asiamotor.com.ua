                        ...
                        <div class="tab-content">
                            ...
                            <?php if(!isset($license_error) ) { ?>
                                ...
                                <div class="tab-pane" id="tab-product">
                                    <?php $widgets->dropdown('lookup_product',array(3 => $text_disabled, 0 => $text_bysku, 1 => $text_byname, 2 => $text_bymodel, 4 => $text_bycode, )); ?>
                                            ...
                                            <?php foreach ($neoseo_exchange1c_price_type as $obj) { ?>
                                                ...
                                                <?php } else { ?>
                                                    <tr id="exchange1c_price_type_row<?php echo $price_row; ?>">
                                                        ...
                                                        <td class="left"><select class="form-control" name="neoseo_exchange1c_price_type[<?php echo $price_row; ?>][customer_group_id]">
