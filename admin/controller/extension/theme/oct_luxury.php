...
class ControllerExtensionThemeOctluxury extends Controller {
    ...
    public function install() {
        ...
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/theme/oct_luxury');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/theme/oct_luxury');
