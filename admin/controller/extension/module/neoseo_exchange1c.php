...
class ControllerExtensionModuleNeoSeoExchange1c extends NeoSeoController
{
	...
	public function index()
	{
		...
		$data = $this->initBreadcrumbs(array(
			...
			array("extension/neoseo_exchange1c", "heading_title_raw")
		    ), $data);
		...
		$data['check_password'] = $this->url->link('extension/module/neoseo_exchange1c/check_password', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->load->model("extension/module/neoseo_exchange1c");
		$this->model_extension_module_neoseo_exchange1c->upgrade();
		...
		$this->response->setOutput($this->load->view('extension/module/neoseo_exchange1c.tpl', $data));
	}

	private function validate()
	{

		if (!$this->user->hasPermission('modify', 'extension/module/neoseo_exchange1c')) {
