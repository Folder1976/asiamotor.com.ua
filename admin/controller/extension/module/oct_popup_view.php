...
class ControllerExtensionModuleOctPopupView extends Controller {
    ...
    public function index() {
        ...
        $data['entry_advantages_tab']    = $this->language->get('entry_advantages_tab');
        ...
        if (isset($data['oct_popup_view_data']['image_additional_width']) && $data['oct_popup_view_data']['image_additional_width'] < 200) {
            $data['oct_popup_view_data']['image_additional_width'] = 200;
        }

        if (isset($data['oct_popup_view_data']['image_additional_height']) && $data['oct_popup_view_data']['image_additional_height'] < 200) {
            $data['oct_popup_view_data']['image_additional_height'] = 200;
        }

        if (!isset($data['oct_popup_view_data']['advantages'])) {
    ...
    public function install() {
        ...
        $this->model_setting_setting->editSetting('oct_popup_view', array(
            'oct_popup_view_data' => array(
                ...
                'image_height' => '560',
                'additional_image' => '1',
                'image_additional_width' => '200',
                'image_additional_height' => '200'
            )
        ));
