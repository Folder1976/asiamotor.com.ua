...
class ControllerExtensionModuleOctProductFilter extends Controller {
    ...
    public function index() {
        ...
        foreach ($attribute_filters as $attribute_filter) {
            $attribute_group_info = $this->model_catalog_attribute_group->getAttributeGroupDescriptions($attribute_filter['attribute_group_id']);

            if (isset($attribute_group_info[(int)$this->config->get('config_language_id')]['name']) && !empty($attribute_group_info[(int)$this->config->get('config_language_id')]['name'])) {
                $name = $attribute_group_info[(int)$this->config->get('config_language_id')]['name'] .' > '.$attribute_filter['attribute_name'];
            } else {
