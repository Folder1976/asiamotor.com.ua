...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		if (isset($this->request->post['config_ceo_product_title'])) {
			$data['config_ceo_product_title'] = $this->request->post['config_ceo_product_title'];
		} else {
			$data['config_ceo_product_title'] = $this->config->get('config_ceo_product_title');
		}

		if (isset($this->request->post['config_ceo_product_h1'])) {
			$data['config_ceo_product_h1'] = $this->request->post['config_ceo_product_h1'];
		} else {
			$data['config_ceo_product_h1'] = $this->config->get('config_ceo_product_h1');
		}

		if (isset($this->request->post['config_ceo_product_description'])) {
			$data['config_ceo_product_description'] = $this->request->post['config_ceo_product_description'];
		} else {
			$data['config_ceo_product_description'] = $this->config->get('config_ceo_product_description');
		}

		if (isset($this->request->post['config_ceo_product_keywords'])) {
			$data['config_ceo_product_keywords'] = $this->request->post['config_ceo_product_keywords'];
		} else {
			$data['config_ceo_product_keywords'] = $this->config->get('config_ceo_product_keywords');
		}

		if (isset($this->request->post['config_ceo_category_title'])) {
			$data['config_ceo_category_title'] = $this->request->post['config_ceo_category_title'];
		} else {
			$data['config_ceo_category_title'] = $this->config->get('config_ceo_category_title');
		}

		if (isset($this->request->post['config_ceo_category_h1'])) {
			$data['config_ceo_category_h1'] = $this->request->post['config_ceo_category_h1'];
		} else {
			$data['config_ceo_category_h1'] = $this->config->get('config_ceo_category_h1');
		}

		if (isset($this->request->post['config_ceo_category_description'])) {
			$data['config_ceo_category_description'] = $this->request->post['config_ceo_category_description'];
		} else {
			$data['config_ceo_category_description'] = $this->config->get('config_ceo_category_description');
		}

		if (isset($this->request->post['config_ceo_category_keywords'])) {
			$data['config_ceo_category_keywords'] = $this->request->post['config_ceo_category_keywords'];
		} else {
			$data['config_ceo_category_keywords'] = $this->config->get('config_ceo_category_keywords');
		}
