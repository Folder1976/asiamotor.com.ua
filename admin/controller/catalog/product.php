...
class ControllerCatalogProduct extends Controller {
	...
	public function delete_is_disabled(){
		
		$this->load->model('catalog/product');
		
		$results = $this->db->query("SELECT product_id FROM ".DB_PREFIX."product WHERE status='0' AND product_id NOT IN (SELECT product_id FROM ".DB_PREFIX."product_to_category)");
	...
	protected function getList() {
		...
		$data['delete_is_disabled'] = $this->url->link('catalog/product/delete_is_disabled', 'token=' . $this->session->data['token'], true);
