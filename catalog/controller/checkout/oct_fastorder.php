...
class ControllerCheckoutOctFastorder extends Controller {
    ...
    public function payment_address($render = true, &$data = array()) {
        ...
        $data['custom_fields'] = $this->model_account_custom_field->getCustomFields(array(
            'filter_customer_group_id' => $this->config->get('config_customer_group_id')
        ));
    ...
    public function payment_address_validate(&$data = array()) {
        ...
        if (!$json) {
            if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
                ...
                $custom_fields = $this->model_account_custom_field->getCustomFields(array(
                    'filter_customer_group_id' => $this->config->get('config_customer_group_id')
                ));
