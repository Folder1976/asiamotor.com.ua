...
class ControllerApiOrder extends Controller {
	...
	public function history() {
		...
		//Если зашли с таким токеном то это норм
		if(isset($this->request->get['token']) AND $this->request->get['token'] == 'caacdda25846fd6d10927310e0f307d6'){
			$this->session->data['api_id'] = 'caacdda25846fd6d10927310e0f307d6';
