...
class ControllerExtensionModuleOctBlogArticle extends Controller {
    public function index($setting) {
        ...
        $data['heading_title'] = isset($setting['heading'][$this->session->data['language']]) ? $setting['heading'][$this->session->data['language']] : '';
        $data['link']          = isset($setting['link'][$this->session->data['language']]) ? $setting['link'][$this->session->data['language']] : '';
