...
class ControllerExtensionModuleOctProductPreorder extends Controller {
    ...
    public function send() {
        ...
        if (isset($this->request->post['telephone']) && !empty($oct_product_preorder_data['mask'])) {
            $phone_count = utf8_strlen(str_replace(array('_','-','(',')','+',' '), "", $oct_product_preorder_data['mask']));

            if ((isset($oct_product_preorder_data['telephone']) && $oct_product_preorder_data['telephone'] == 2) && utf8_strlen(str_replace(array('_','-','(',')','+',' '), "", $this->request->post['telephone'])) < $phone_count) {
                $json['error']['field']['telephone'] = $this->language->get('error_telephone_mask');
            }
        } elseif (isset($this->request->post['telephone'])) {
            if ((isset($oct_product_preorder_data['telephone']) && $oct_product_preorder_data['telephone'] == 2) && (utf8_strlen(str_replace(array('_','-','(',')','+',' '), "", $this->request->post['telephone'])) > 15 || utf8_strlen(str_replace(array('_','-','(',')','+',' '), "", $this->request->post['telephone'])) < 3)) {
