...
class ControllerStartupSeoUrl extends Controller {
	public function index() {
        ...
        if ($query->row['query'] && $url[0] != 'newsblog_category_id' && $url[0] != 'newsblog_article_id' && $url[0] != 'information_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id' && $url[0] != 'oct_blog_category_id' && $url[0] != 'oct_blog_article_id') {
        // oct_blog end
	...
	public function rewrite($link) {
        ...
        if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'newsblog/article' && $key == 'newsblog_article_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'octemplates/blog_article' && $key == 'oct_blog_article_id')) {
