<div id="cart-popup" class="white-popup wide-popup mfp-with-anim">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    <a href="<?php echo $product['href']; ?>" class="popup-table-text"><?php echo $product['name']; ?></a>
                ...
                <tr>
                  <td class="delete-td"><button type="button" onclick="oct_popup_voucher_remove('<?php echo $voucher['key']; ?>');">×</button></td>
