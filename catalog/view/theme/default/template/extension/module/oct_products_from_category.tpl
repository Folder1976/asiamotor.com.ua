...
<?php if (isset($view) && $view == 'carousel') { ?>
...
<?php } ?>	
	<div class="row carousel-module-row">
		<div class="carousel-module-row-header"><a href="<?php echo $titlelink; ?>"><?php echo $title; ?></a></div>
		<div id="owl-carousel-module-pfc-<?php echo $module; ?>" class="owl-carousel owl-theme">
...
<script>
$('#owl-carousel-module-pfc-<?php echo $module; ?>').owlCarousel({
...
<?php if($position == "column_left" OR $position == "column_right") { ?> 
<?php } else { ?>
<div class="container grid-module-container">
	<div class="row carousel-module-row">
		<div class="col-sm-12 carousel-module-row-header"><a href="<?php echo $titlelink; ?>"><?php echo $title; ?></a></div>
	</div>
	<div id="grid-module-pfc-<?php echo $module; ?>" class="row grid-module-row">
		<?php foreach ($products as $product) { ?>   
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="oct-module-button">
				<button id="grid-module-pfc-button-<?php echo $module; ?>"><?php echo $button_view_more; ?></button>
			</div>
		 </div>
	</div>
</div>
<script>
	octShowProducts("grid-module-pfc-button-<?php echo $module; ?>", "grid-module-pfc-<?php echo $module; ?>", 4, "<?php echo count($products); ?>");
</script>
<?php } ?>
<?php } ?>
<?php } ?>