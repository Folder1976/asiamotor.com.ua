<div id="subscribe-popup" class="white-popup wide-popup mfp-with-anim">
  ...
  <div class="popup-center">
    <div class="popup-text">
      ...
      <?php if ($thumb) { ?>
      <img src="image/<?php echo $thumb; ?>" alt="" class="img-responsive" />
      <?php } ?>
    </div>
    <div class="popup-form-box">
      <form method="post" enctype="multipart/form-data" id="popup-subscribe-form">
        ...
        <?php } ?>
        <button class="subscr-button" title="<?php echo $button_subscribe; ?>" type="button" id="popup-subscribe-button"><?php echo $button_subscribe; ?></button>
      </form>
    </div>
  </div>
  <script><!--
