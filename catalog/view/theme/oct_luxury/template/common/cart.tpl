<?php if (isset($oct_popup_cart_data['status']) && $oct_popup_cart_data['status']) { ?>
  <div id="cart" class="btn-group btn-block">
    <div onclick="get_oct_popup_cart();" class="cart-btn btn btn-inverse btn-block btn-lg">
      <div class="input-group-btn cart-name"><?php echo $text_cart_heading; ?></div> 
...
<?php } else { ?>
  <div id="cart" class="btn-group btn-block">
    <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="cart-btn btn btn-inverse btn-block btn-lg dropdown-toggle">
      <div class="input-group-btn cart-name"><?php echo $text_cart_heading; ?></div> 
