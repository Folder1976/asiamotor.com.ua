      ...
      <div class="inner-box<?php if (!$oct_product_filter_data['tag_collapsed']) { ?> expanded<?php } ?>" data-sort="<?php echo $oct_product_filter_data['tag_sort_order']; ?>" data-type="tag">
        ...
        <div class="list-group-item item-content">
          ...
          <div class="input-group">
            <input type="text" name="tag" value="<?php echo str_replace('_',' ',$tag); ?>" class="form-control" placeholder="<?php echo $entry_tag; ?>" />
...
<?php } ?>
<?php if (isset($oct_filter) && $oct_filter && $filter_start) { ?>
$(function() {
