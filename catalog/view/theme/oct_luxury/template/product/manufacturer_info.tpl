     ...
     <div class="row sort-row">
      ...
      <div class="row filter-products">
        ...
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb<?php echo $product['quantity'] <= 0 ? ' no_quantity' : ''?>">
...
<?php if ((isset($thumb) && $thumb) || (isset($description) && strlen($description) > 15)) { ?>
<div class="desc-cat">
	<div class="container">
	  <div class="row">
	    ...
	    <?php } ?>
	    <?php if (isset($description) && strlen($description) > 40) { ?>
