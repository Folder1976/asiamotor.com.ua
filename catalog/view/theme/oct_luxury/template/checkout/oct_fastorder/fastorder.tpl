					  ...
					  <div class="panel-body">
						  ...
						  <div class="row">  
						    ...
						    <?php if ($addresses) { ?>
							      ...
							      <div class="radio"><label><input type="radio" name="payment_address" value="new" onclick="$('#payment-address-new').show();"/><?php echo $text_address_new; ?></label></div>
								  </div>
								  <?php } ?>
					      <?php } ?>
									...
									<div class="col-sm-12">
									  ...
									  <div class="shipping-address" <?php if (isset($shipping_address_id) || isset($customer_id)) echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
									    <?php if ($addresses) { ?>
										    ...
										    <?php } ?>
										    <?php if (isset($customer_id)) { ?>
										      <div class="radio"><label><input type="radio" name="shipping_address" value="new" onclick="$('#shipping-new').show();"/><?php echo $text_address_new; ?></label></div>
											  <?php } ?>
									    <?php } ?>
...
<script><!--
<?php if ($mask) { ?>
  $("input[name=\'telephone\']#input-payment-telephone").mask("<?php echo $mask; ?>", {placeholder: "<?php echo $mask; ?>"});
<?php } ?>
