				                                 ...
				                                 <?php foreach ($item['children'] as $children) { ?>
				                                    <div class="col-sm-<?php if (strlen($item['description']) < 15) { ?>2<?php } else { ?>4<?php } ?> static-menu">
				                                       <div class="menu">
				                                          <ul class="brands-ul">
				                                             <li>
				                                                <a href="<?php echo $children['href']; ?>" id="menu_item_car" class="main-menu with-submenu"><img src="<?php echo $children['thumb']; ?>" alt="alt" class="img-responsive" /><span><?php echo $children['name']; ?></span></a>
				                                             </li>
				                                          </ul>
				                                       </div>
				                                    </div>
...
<script>
	...
	var b4 = viewport().width;
	    ...
	    if (b4 <= 992) {
		    ...
		    $( ".mob-menu-ul" ).append( "<h2 class=\"sidebar-account-header\"><?php echo $text_acc; ?></h2>" );
			$( ".sidebar-account" ).clone().appendTo( ".mob-menu-ul" );
			$("#menu-mobile").append( $( ".mob-menu-ul" ) );
			
			$( ".mob-menu-ul" ).append( "<h2 class=\"sidebar-info-header\"><?php echo $text_info; ?></h2>" );
			$(".mob-menu-ul").append( $( ".sidebar-info" ) );
			
			$( ".mob-menu-ul" ).append( "<h2 class=\"sidebar-settings-header\"><?php echo $text_settings; ?></h2>" );
			...
			$( "<h2 class=\"sidebar-contacts-header\"><?php echo $text_contacts; ?></h2>" ).insertBefore( "#sidebar-contacts" );
...
<!-- Mobile -->
	...
	<ul class="mob-menu-ul">
		<li>
			<a href="javascript:void(0);"><?php echo $text_category; ?></a>
			<ul>
		<?php foreach ($items as $item) { ?>
	       	<?php if ($item['children']) { ?>
	          	<?php if ($item['item_type'] == 2) { ?>
