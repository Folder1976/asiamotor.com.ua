	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				if($language->get('text_status_'.$order_status_id) != ''){
					$text = $language->get('text_status_'.$order_status_id);
				}
				
				
				$data['text_greeting'] = sprintf($text, $order_info['store_name']);
			...
			if ($order_info['order_status_id'] && $order_status_id && $notify) {
				...
				if($language->get('text_status_'.$order_status_id) != ''){
					$message .=$text = '<br>'.$language->get('text_status_'.$order_status_id).'<br>';
				}else{
